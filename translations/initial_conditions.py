...
class Param:
    ...
    def __init__(self,nx=100):
        ...
        self.xs=tf.cast(tf.linspace(self.xmin,self.xmax,self.nx),tf.float32)
...
class FuncGenerator:
    ...
    def __init__(self, param: Param,batch_size=64):
        self.param = param
    ...
    def __call__(self):
        ...
        return self.generate_func_continuous()*continuity_sizes+self.generate_discontinuity()*discont_sizes
