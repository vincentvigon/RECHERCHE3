...
class Param:
    ...
    def __init__(self,
                 ...
                 nx_ratio=10,
                 BC_solver="periodic",
                 BC_model=None,  # None=> BC_model=BC
                 xmin=0.,
                 xmax=1.,
                 CFL=0.5,
                 gamma=1.4,
                 ...
                 order=1,
                 HLLC=True,
                 flux_correction="flux"#viscosity, slopes
                 ):
        ...
        # il faut changer ce paramètre quand on modifie Var_burger.get_augmentation
        self.augmentation_dim = 2
        self.n_equations = 1
        ...
        self.final_activation = "relu" if flux_correction == "viscosity" else None
